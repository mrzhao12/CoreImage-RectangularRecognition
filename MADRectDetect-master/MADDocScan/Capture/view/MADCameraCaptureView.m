...
//         NSData *imageData = [AVCaptureStillImageOutput jpegStillImageNSDataRepresentation:imageSampleBuffer];// AVCapturePhotoOutput
         ...
         if (strongSelf.isBorderDetectionEnabled)
         {
             ...
             NSLog(@"里面的image:::::%@",image);
             NSLog(@"里面的rectangleFeature::::%@",rectangleFeature);
